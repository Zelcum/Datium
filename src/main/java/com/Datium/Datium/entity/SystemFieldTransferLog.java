...
@Entity
@Table(name = "system_field_transfer_logs")
public class SystemFieldTransferLog {
    @Id
    ...
    @Column(name = "transferred_records")
    private Integer transferredRecords;
    ...
    public Integer getTransferredRecords() {
        return transferredRecords;
    }

    public void setTransferredRecords(Integer transferredRecords) {
        this.transferredRecords = transferredRecords;
    }

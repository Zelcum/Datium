...
public class SystemService {
    ...
    public List<SystemResponse> getAllSystems(Integer userId) {
        try {
            ...
            List<com.Datium.Datium.entity.SystemShare> sharedSystems = systemShareRepository
    ...
    public Map<String, Object> getCreateLimit(Integer userId) {
        ...
        Long maxSystems = plan != null && plan.getMaxSystems() != null ? plan.getMaxSystems().longValue() : 1L; // Fallback
                                                                                                                // to 1
                                                                                                                // if no
                                                                                                                // plan

        // If plan has very high number (like 99999999), consider it unlimited for UI
        // purposes, but let's just return the number
